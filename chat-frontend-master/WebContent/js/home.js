...
Chatbucket.controller('registerController', ['$scope', 'fileUpload', function($scope,fileUpload){
    $scope.register = function(){
       ...
       console.log('file is ' );
       console.dir(file);
       var uploadUrl = "http://localhost:9090/Chatbucket/fileUpload";
	  ...
	  ChatService.receive().then(null, null, function(message) {
		...
		Chatbucket.controller("JobsController",function($scope,$http)
			...
			$scope.addJ=function()
			{
				...
				var res=$http.post("http://localhost:9090/Chatbucket/addJobs",jobs);
				...
				Chatbucket.controller("loginController",['$cookieStore','$scope','$http','$location','$rootScope',function($cookieStore,$scope,$http,$location,$rootScope)
					...
					$http.post("http://localhost:9090/Chatbucket/authenticate",logi).then(function(response)
							{
				...
				Chatbucket.controller("blogController",function($scope,$http,$rootScope)	
					...
					$http.get("http://localhost:9090/Chatbucket/viewMyBlogs/"+$rootScope.uname)
							 ...
							 $scope.newBlog={};
								...
								$scope.addBlog=function(newBlog)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:9090/Chatbucket/addBlog',dataObj);
									 $http.get("http://localhost:9090/Chatbucket/viewMyBlogs/"+$rootScope.uname)
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:9090/Chatbucket/updateBlog",edit);
					$http.get("http://localhost:9090/Chatbucket/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				$http.post("http://localhost:9090/Chatbucket/deleteBlog",del);
					$http.get("http://localhost:9090/Chatbucket/viewMyBlogs/"+$rootScope.uname)
					    .then(function (response) {
				...
				Chatbucket.controller("adminBlogController",function($scope,$http,$rootScope)	
					...
					console.log(" in adminblog controller");
							 ...
							 $http.get("http://localhost:9090/Chatbucket/viewBlogs")
							    .then(function (response) {
				...
				Chatbucket.controller("adminJobsController",function($scope,$http,$rootScope)	
					...
					console.log(" in jobs controller");
							 ...
							 $http.get("http://localhost:9090/Chatbucket/viewJobs")
							    .then(function (response) {
							 ...
							 $scope.newJobs={};
								...
								$scope.addJobs=function(newJobs)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:9090/Chatbucket/addJobs',dataObj);
									 $http.get("http://localhost:9090/Chatbucket/viewJobs")
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:9090/Chatbucket/updateJob",edit);
					 $http.get("http://localhost:9090/Chatbucket/viewJobs")
					    .then(function (response) {
				...
				$http.post("http://localhost:9090/Chatbucket/deleteJob",del);
					 $http.get("http://localhost:9090/Chatbucket/viewJobs")
					    .then(function (response) {
				...
				Chatbucket.controller('logoutController',function($scope,$rootScope,$http,$cookieStore)		
						{
					$http.post("http://localhost:9090/Chatbucket/logout/"+$rootScope.uname);
				...
				Chatbucket.controller("adminForumController",function($scope,$http,$rootScope)	
					...
					console.log(" in adminforum controller");
							 ...
							 $http.get("http://localhost:9090/Chatbucket/viewForums")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.addForum=function(newForum)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:9090/Chatbucket/addForum',dataObj);
									 $http.get("http://localhost:9090/Chatbucket/viewForums")
				...
				$scope.approveForum=function()
				{
					...
					$http.put("http://localhost:9090/Chatbucket/updateForum",edit);
					 $http.get("http://localhost:9090/Chatbucket/viewForums")
					    .then(function (response) {
				...
				Chatbucket.controller("userForumController",function($scope,$http,$rootScope)	
					...
					console.log(" in forum controller");
							 ...
							 $http.get("http://localhost:9090/Chatbucket/viewForum")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.answer=function(forum)
								{
									...
									answer:$scope.answerforum.answer
									 ...
									 $http.post('http://localhost:9090/Chatbucket/answerForum',ans);
									$http.get("http://localhost:9090/Chatbucket/viewForum")
								    .then(function (response) {
								...
								$scope.viewanswers=function(forum)
								{
									...
									console.log("forumid:"+$scope.answerforum.forum_id);
									 $http.get("http://localhost:9090/Chatbucket/viewAnswers/"+$scope.answerforum.forum_id)
									    .then(function (response) {
				...
				$http.post("http://localhost:9090/Chatbucket/deleteForum",del)
				...
				Chatbucket.controller("userHomeController",function($scope,$http,$rootScope)	
					...
					console.log("name in  findfriends:"+$rootScope.uname);
							 $http.get("http://localhost:9090/Chatbucket/findFriends/"+$rootScope.uname)
							    .then(function (response) {
					...
					$scope.addfriend=function(user)
					{
						...
						$http.post("http://localhost:9090/Chatbucket/addFriend/",fr);
				...
				Chatbucket.controller("friendslistController",function($scope,$http,$rootScope)	
					...
					console.log("name in  friendslist:"+$rootScope.uname);
							 $http.get("http://localhost:9090/Chatbucket/viewFriends/"+$rootScope.uname)
							    .then(function (response) {
				...
				Chatbucket.controller("allblogsController",function($scope,$http,$rootScope,$route)	
					...
					console.log("username in allblog controller:"+$rootScope.uname);
							 $http.get("http://localhost:9090/Chatbucket/viewAllBlogs")
							    .then(function (response) {
							 ...
							 { 
						       ...
						       var like=
								...
								console.log("postedby:"+$rootScope.uname);
								 $http.put('http://localhost:9090/Chatbucket/updateBlog',like);
								 $http.get("http://localhost:9090/Chatbucket/viewBlogs")
								    .then(function (response) {
					 ...
					 $http.get("http://localhost:9090/Chatbucket/viewComments/"+$scope.viewcomments.blog_id)
								    .then(function (response) {
						...
						$scope.comment=function(allblogs)
						{
							...
							$http.post('http://localhost:9090/Chatbucket/addComment',comment);
							 $http.get("http://localhost:9090/Chatbucket/viewBlogs")
							    .then(function (response) {
